...
import { HybridRetriever, HybridRetrievalResult } from './hybrid-retrieval.js';
...
async function testMergeResults() {
  ...
  const vectorResults = [
    { id: 1, content: 'TypeScript tutorial', similarity: 0.9, type: 'semantic' as const },
    { id: 2, content: 'PostgreSQL guide', similarity: 0.8, type: 'semantic' as const },
    { id: 3, content: 'React tips', similarity: 0.7, type: 'episodic' as const },
  ];

  const graphResults = [
    { id: 1, content: 'TypeScript tutorial', weight: 0.95, type: 'semantic' as const },  // Duplicate
    { id: 4, content: 'Database design', weight: 0.85, type: 'semantic' as const },
  ];

  const merged = retriever.mergeResults(vectorResults as any, graphResults as any);
