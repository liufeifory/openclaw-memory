 ...
 */
function sortMemoriesByScore(memories: any[], intent: string, hasDetail: boolean): any[] {
  return memories.sort((a, b) =>
    calculateMemoryScore(b, intent, hasDetail) - calculateMemoryScore(a, intent, hasDetail)
  );
}
